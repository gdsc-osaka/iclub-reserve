  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          /*
           * ここだけ shadcn の生成コードから data-open バリアントを外している。
           * Tooltip の data-state は delayed-open / instant-open / closed の 3 つしかなく、
           * data-open が指す [data-state="open"] には一度も一致しないため。
           * キーボードで開いたとき (instant-open) にアニメーションが効かなくなる。
           */
