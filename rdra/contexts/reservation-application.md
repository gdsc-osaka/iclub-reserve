...
boundary:
  usecases:
    ...
    - id: "UC-002"
      ...
      events: ["EVT-001"]
      traces_to: ["BUC-001"]
      description: "申請元の団体・施設/設備・日時・使用人数・備考を入力して仮予約を申請する。申請元にできるのは、自分が所属する団体（事務局は所属に関わらず全団体。COND-009）のうち有効な団体のみ（COND-006）。申請時に申請者・団体管理者全員・事務局へメール通知。"
    - id: "UC-003"
      name: "仮予約を取り消す"
      actors: ["ACTOR-002"]
      screens: ["SCR-003"]
  ...
  screens:
    ...
    - id: "SCR-002"
      name: "予約申請フォーム"
      description: "申請元の団体・施設/設備・日時（タイムラインUI）・使用人数（必須）・備考を入力して仮予約を申請するフォーム。申請元の団体は、自分が所属する有効な団体（事務局は有効な全団体）から選ぶ。選べる団体が1つだけのときは選ばせず、団体名を表示する。ステータスは常に仮予約として作成され、申請者が選ぶことはできない（STATE-001）。"
      information: ["INFO-001", "INFO-002", "INFO-003"]
    - id: "SCR-003"
      name: "予約一覧・管理画面"
...
system:
  ...
  conditions:
    ...
    - id: "COND-008"
      ...
      traces_to: ["UC-001", "UC-005", "UC-009"]
  variations: []
---
