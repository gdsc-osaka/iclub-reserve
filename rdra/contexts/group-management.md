...
value:
  ...
  requirements:
    ...
    - id: "REQ-019"
      ...
      traces_to: ["GOAL-001"]
    - id: "REQ-020"
      description: "オーナーまたは事務局が団体情報（名称等）を編集できる。連絡先はオーナー全員の大学メールアドレスが自動的に使用される。"
      traces_to: ["GOAL-001"]
    - id: "REQ-021"
...
environment:
  business_usecases:
    - id: "BUC-010"
      name: "団体の新規作成"
      actors: ["ACTOR-002"]
      description: "ユーザーが団体名を入力して団体を作成する。作成者が初期オーナーになる。連絡先は常にオーナー全員の大学メールアドレスが自動設定される（作成直後はオーナーが作成者1人のため作成者のメールのみ）。"
      traces_to: ["REQ-016"]
    - id: "BUC-011"
      name: "メンバーの追加・削除"
    ...
    - id: "BUC-013"
      name: "団体情報の編集"
      actors: ["ACTOR-001", "ACTOR-002"]
      description: "オーナーまたは事務局が団体名・連絡先等を編集する。"
      traces_to: ["REQ-020"]
    - id: "BUC-014"
      name: "事務局による団体の無効化"
      actors: ["ACTOR-001"]
...
boundary:
  usecases:
    - id: "UC-010"
      ...
      events: []
      traces_to: ["BUC-010"]
      description: "団体名を入力して団体を作成する。作成者が初期オーナーになる。連絡先は常にオーナー全員の大学メールアドレスが自動設定される（作成直後はオーナーが作成者1人のため作成者のメールのみ）。"
    - id: "UC-011"
      name: "メンバーを追加・削除する"
      actors: ["ACTOR-001", "ACTOR-002"]
      screens: ["SCR-007"]
  ...
  screens:
    - id: "SCR-006"
      name: "団体作成フォーム"
      description: "団体名を入力して新しい団体を作成するフォーム。連絡先は常にオーナー全員の大学メールアドレスが自動設定される（REQ-020）。作成直後はオーナーが作成者1人のため作成者のメールのみとなる。"
      information: ["INFO-003"]
    - id: "SCR-007"
      name: "団体管理画面"
      description: "団体情報の編集、メンバーの追加・削除・オーナー昇格・降格を行う画面。オーナーと事務局が操作できる。"
...
sequenceDiagram
    ...
    システム->>システム: 作成者をオーナーとして登録・連絡先に大学メールを自動設定
    システム-->>ユーザー: 作成完了
```
